...
<div class='container pt-4'>
    ...
    <thead>
        ...
        <th scope='col'>cliente: <?php echo $nickLog ?></th>
...
?>
	...
	<input class="btn btn-danger" type="submit" value="Vaciar cesta">
    </form>
